  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '40px 24px' }}>
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: 40 }}>
        ...
        <p style={{ color: T.textMuted, margin: '4px 0 0', fontSize: 14 }}>Sertifikaattivalmistelua pelillistettynä</p>
      </motion.div>
      ...
      >
        <GlassCard hoverable onClick={() => navigate('/modules')} style={{ padding: 32 }}>
          ...
          <p style={{ margin: 0, color: T.textMuted, fontSize: 14 }}>Tenttikysymyksiä mukautuvan oppimisen algoritmilla</p>
        </GlassCard>
